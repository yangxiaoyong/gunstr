...
INSERT INTO probe VALUES (15, 3, 'Total processing', 'total', NULL, NULL);
...
INSERT INTO host VALUES (1, 'yxy-X200', 'localhost', '8080');

--- *******************************
--- Table: HOSTPROBE
--- Description: Maps availabe probes to the hosts
---              overrides threholds if required
...
--- *******************************
--- Table: TICKETQUEUE
--- Description: Holds all pending and sent tickets
...
INSERT INTO probingschedule VALUES (1, 11, 1); INSERT INTO probingschedule VALUES (2, 15, 1); INSERT INTO probingschedule VALUES (3, 8, 5);
...
---              allows to override to the default values
